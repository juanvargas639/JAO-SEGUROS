<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarPoliza.aspx.cs" Inherits="JAO_Seguros.Aplicacion.PagAsesor.EditarPoliza" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="../../library/dashboardAsesor/vendors/tempusdominus-bootstrap-4/tempusdominus-bootstrap-4.min.css">
            ...
            <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                    <a class="navbar-brand brand-logo mr-5" href="DefaultAsesor.aspx">
                        <img src="../../library/dashboardAsesor/images/logo.png" class="mr-2" alt="logo" /></a>
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active text-info" id="home-tab" data-toggle="tab" href="#home-1" role="tab"
                                            aria-controls="home-1" aria-selected="true">Información del Póliza
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col">
                                                            <label class="campoobligatorio">*</label><label for="txtInstitucionEditarPolizaEstudiantil" id="lbEditarPolizaEstudiantil">
                                                                Institución</label>
                                                            <asp:TextBox ID="txtInstitucionEditarPolizaEstudiantil" Text="Prueba" name="txtInstitucionEditarPolizaEstudiantil" runat="server" title="Institución en mayúsculas" placeholder="Ingresa la Institución" TextMode="SingleLine" class="form-control" pattern="[A-Z0-9]+/" />
                                                ...
                                                <div style="float: right;">
                                                    <asp:Button ID="btnEditarPoliza" runat="server" class="btn btn-primary" Text="Guardar Cambios" OnClick="btnEditarPoliza_Click" ValidationGroup="EditarPoliza" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group row">
                                                            <div class="col">
                                                                ...
                                                                <br>
                                                                <div>
                                                                    <asp:LinkButton ID="btnDeletePoliza" runat="server" class="btn btn-danger btn-icon-text" OnClick="btnDeletePoliza_Click"
                                                                        OnClientClick="return EliminarPoliza()"><i class="ti-close btn-icon-prepend"></i>Eliminar Póliza</asp:LinkButton>
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <asp:Panel ID="PANELELIMINARPOLIZA" runat="server" Visible="false">
                                                                    ...
                                                                    <br>
                                                                    <div>
                                                                        <asp:LinkButton ID="btnEliminarPoliza" runat="server" class="btn btn-danger btn-icon-text"
                                                                            OnClick="btnEliminarPoliza_Click" OnClientClick="return EliminarArchivo()"><i class="ti-eraser btn-icon-prepend"></i>Eliminar archivo</asp:LinkButton>
                                                                    </div>
                                                                </asp:Panel>
                                                            </div>
                                                        </div>
