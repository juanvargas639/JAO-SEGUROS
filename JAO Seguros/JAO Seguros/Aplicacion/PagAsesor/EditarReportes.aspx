<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarReportes.aspx.cs" Inherits="JAO_Seguros.Aplicacion.PagAsesor.EditarReportes" %>
                    ...
                    <div class="content-wrapper">
                        <div class="row">
                            <div class="col-12 grid-margin">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Reporte de mi cliente</h4>
                                        <br>
                                        ...
                                        <div class="form-group row">
                                            <div class="col">
                                                ...
                                                <asp:TextBox class="form-control" ID="txtDescripcionReporte" runat="server" Rows="2" TextMode="MultiLine" ReadOnly="true" BackColor="White"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col">
                                        ...
                                        <asp:UpdatePanel ID="PANEL" runat="server">
                                            <ContentTemplate>
                                                <div style="float: right;">
                                                    <asp:Button ID="btnEditarReporte" runat="server" class="btn btn-primary" Text="Guardar Respuesta" OnClick="btnEditarReporte_Click" />
                                                </div>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
