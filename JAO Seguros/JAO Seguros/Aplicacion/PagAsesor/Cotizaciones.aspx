<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cotizaciones.aspx.cs" Inherits="JAO_Seguros.Aplicacion.PagAsesor.Cotizaciones" %>
...
<body>
    ...
    <form id="FormCotizaciones" runat="server">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Cotizaciones recibidas</h4>
                                <br>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="TablaCotizacionesAsesorActivas" CssClass="table" GridLines="None" runat="server" DataKeyNames="IDCotizacion" BorderStyle="None" RowStyle-BorderColor="#CED4DA" RowStyle-BorderStyle="Solid" RowStyle-BorderWidth="0.5pt" AutoGenerateColumns="false">
                                                <Columns>
                                                    <asp:BoundField HeaderText="ID Cotización" DataField="IDCotizacion" />
                                                    <asp:BoundField HeaderText="Nombre Prospecto" DataField="NombreProspecto" />
                                                    <asp:BoundField HeaderText="Apellido Prospecto" DataField="ApellidoProspecto" />
                                                    <asp:BoundField HeaderText="Descripción" DataField="DescripcionCotizacion" />
                                                    <asp:BoundField HeaderText="Ramo" DataField="RamoCotizacion" />
                                                    <asp:BoundField HeaderText="Correo Prospecto" DataField="CorreoProspecto" />
                                                    <asp:BoundField HeaderText="Fecha de Cotización" DataField="FechaCotizacion" SortExpression="FechaCotizacion" DataFormatString="{0:d}" />
                                                    <asp:BoundField HeaderText="Cotización Enviada" DataField="EnviadaCotizacion" />
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblAction" runat="server" Text="Acción"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkBtnEdit" runat="server" CommandArgument='<%# Eval("IDCotizacion")%>'
