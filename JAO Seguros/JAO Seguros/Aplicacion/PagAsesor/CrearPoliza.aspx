<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearPoliza.aspx.cs" Inherits="JAO_Seguros.Aplicacion.PagAsesor.CrearPoliza" %>
...
<body>
    ...
    <form id="FormCrearPoliza" runat="server">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div style="float: right;">
                                            <asp:Button ID="btnCrearPoliza" runat="server" class="btn btn-primary" OnClick="btnCrearPoliza_Click" ValidationGroup="CrearPoliza" Text="Crear Póliza"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="../../library/dashboardAsesor/js/formpickers2.js"></script>
