...
namespace JAO_Seguros.Aplicacion.PagAdmin
{
    public partial class EditarPoliza : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        List<Cliente> listaCliente = gestionCliente.listadoIDClientes();
                        ListItem i;
                        foreach (var item in listaCliente)
                        {
                            i = new ListItem(item.DocumentoCliente);
                            listaClientes.Items.Add(i);
                        }
                        List<Aseguradora> listaAseguradoras = gestionAseguradora.listadoNitAseguradoras();
                        ListItem x;
                        foreach (var item in listaAseguradoras)
                        {
                            x = new ListItem(item.NitAseguradora);
                            listaProveedores.Items.Add(x);
        ...
        {
            /*--TRAER EL NOMBRE DEL ARCHIVO SUBIDO--*/
        ...
        {
            /*--SELECCIONAR PROVEEDOOR DE LA LISTA--*/
