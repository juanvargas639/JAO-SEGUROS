<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarCliente.aspx.cs" Inherits="JAO_Seguros.Aplicacion.PagAdmin.EditarCliente" %>
                ...
                <div class="main-panel">
                    ...
                    <i class="ti-settings text-info ml-2"></i>
                                            ...
                                            <ContentTemplate>
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col">
                                                                <label for="txtEditarNumDocumentoCliente" id="lbEditarNumDocumentoCliente">
                                                                    <label class="campoobligatorio">*</label>Número de
                        Documento</label>
                                                                <asp:TextBox ID="txtEditarNumDocumentoCliente" name="txtEditarNumDocumentoCliente" runat="server"
                                                                    title="Número de Documento del Cliente" placeholder="N° Documento del Cliente"
                                                            ...
                                                            <div class="col">
                                                                <label for="txtEditarFechaExpedicionCliente" id="lbEditarFechaExpedicionCliente">
                                                                    <label class="campoobligatorio">*</label>Fecha de Expedición
                        Documento</label>
                                                                <div id="datepicker-popup12" class="input-group date datepicker">
                        ...
                        Trabajo</label>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col">
                                                                <label class="campoobligatorio">*</label><label for="txtEditarIDEmpleadoCliente" id="lbEditarIDEmpleadoCliente">
                                                                    ID
                        Empleado</label>
                                                                <div class="input-group">
                                                                    ...
                                                                    <asp:TextBox ID="txtEditarIDEmpleadoCliente" name="txtEditarIDEmpleadoCliente" runat="server"
                                                                        placeholder="ID del empleado a cargo" title="ID Empleado a cargo" TextMode="SingleLine"
                                                                        class="form-control"></asp:TextBox>
                                                                </div>
                                                                <small id="emailHelp" class="form-text text-muted">Seleccione el ID del empleado que va a
                        tener este cliente!</small>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Ingresa el ID del empleado a cargo" ControlToValidate="txtEditarIDEmpleadoCliente" ForeColor="Red" ValidationGroup="EditarCliente" SetFocusOnError="true" Font-Size="Small" Font-Bold="true"></asp:RequiredFieldValidator>
                                                            </div>
                                                        </div>
