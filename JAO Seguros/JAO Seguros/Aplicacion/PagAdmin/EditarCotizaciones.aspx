<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarCotizaciones.aspx.cs" Inherits="JAO_Seguros.Aplicacion.PagAdmin.EditarCotizaciones" %>
...
<body>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col">
                                                        <label for="txtEnviada" id="lbEnviada">La cotización ha sido enviada</label>
                                                        <asp:TextBox ID="txtEnviada" class="form-control mb-2 mr-sm-2" name="txtEnviada" runat="server"
                                                            title="Enviada" TextMode="SingleLine" ReadOnly="True" BackColor="White" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col">
                                                        <label for="txtCorreo" id="lbCorreo">Correo del Cotizante</label>
                                                        <asp:TextBox ID="txtCorreo" class="form-control" name="txtCorreo" runat="server"
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <asp:TextBox ID="txtFechaCotizacion" name="txtFechaCotizacion" runat="server"
                                                            title="Fecha de la cotización" TextMode="SingleLine" class="form-control" ReadOnly="True" BackColor="White" />
                                                    </div>
                                                </div>
                                                <asp:Panel ID="PanelAsesor" runat="server" Visible="false">
                                                    <div class="form-group row">
                                                        <div class="col">
                                                            <label for="txtIDAsesor" id="lbIDAsesor">ID Asesor ha cargo</label>
                                                            <asp:TextBox ID="txtIDAsesor" class="form-control" name="txtIDAsesor" runat="server"
                                                                title="ID Cotización" TextMode="SingleLine" ReadOnly="True" BackColor="White" />
                                                        </div>
                                                        <div class="col">
                                                            <label for="txtNombreAsesor" id="lbNombreAsesor">Nombre del Asesor a cargo</label>
                                                            <asp:TextBox ID="txtNombreAsesor" name="txtNombreAsesor" runat="server"
                                                                title="Nombre del Asesor" TextMode="SingleLine" class="form-control" ReadOnly="True" BackColor="White" />
                                                        </div>
                                                    </div>
                                                </asp:Panel>
                                                <div class="form-group row">
                                                    <div class="col">
                                                        ...
                                                        <asp:TextBox ID="txtNombreCotizacion" class="form-control" name="txtNombreCotizacion" runat="server"
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <asp:TextBox ID="txtApellidoCotizacion" name="txtApellidoCotizacion" runat="server"
                                                            title="Apellido Cotizante" TextMode="SingleLine" class="form-control" ReadOnly="True" BackColor="White" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col">
                                                        <label for="txtDescripcion" id="lbDescripcion">Descripción de la Cotización</label>
                                                        <asp:TextBox class="form-control form-control-lg" ID="txtRespuestaReporte" runat="server" Rows="5" TextMode="MultiLine" ReadOnly="True" BackColor="White"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div style="float: right;">
                                                    <asp:LinkButton ID="btnEliminarCotizacion" runat="server" class="btn btn-danger btn-icon-text" OnClick="btnEliminarCotizacion_Click" OnClientClick="return EliminarCotizacion()"><i class="ti-close btn-icon-prepend"></i>Eliminar Cotización</asp:LinkButton>
                                                </div>
                                            </div>
                                        </div>
                                    </ContentTemplate>
    ...
    <script type="text/javascript">
        function EliminarCotizacion(ctl) {
            var defaultAction = $(ctl).prop("href");
            swal({
                title: "¿Desea eliminar la cotización del sistema?",
                ...
                if (isConfirm) {
                    __doPostBack('<%= btnEliminarCotizacion.UniqueID %>', "");
                        return true;
                    }
                });
            return false;
