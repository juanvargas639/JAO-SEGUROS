<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Asesores.aspx.cs" Inherits="JAO_Seguros.Aplicacion.PagAdmin.Asesores" %>
...
<body>
    ...
    <form id="FormAsesores" runat="server">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Asesores activos</h4>
                                <br>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="TablaAsesoresActivos" CssClass="table" GridLines="None" runat="server" DataKeyNames="IDEmpleado" BorderStyle="None" RowStyle-BorderColor="#CED4DA" RowStyle-BorderStyle="Solid" RowStyle-BorderWidth="0.5pt" AutoGenerateColumns="false">
                                                <Columns>
                    ...
                    <footer class="footer">
                        <div class="d-sm-flex justify-content-center justify-content-sm-between">
                            ...
                            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Todos los Derechos
              Reservados.
                            </span>
                        </div>
                    </footer>
