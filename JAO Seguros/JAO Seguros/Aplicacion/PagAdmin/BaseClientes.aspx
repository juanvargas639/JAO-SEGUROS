<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaseClientes.aspx.cs" Inherits="JAO_Seguros.Aplicacion.PagAdmin.BaseClientes" %>
<!DOCTYPE html>
                    ...
                    <div class="content-wrapper">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Clientes registrados en JAO Seguros</h4>
                                <br>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="TablaClientesActivos" CssClass="table" GridLines="None" runat="server" DataKeyNames="DocumentoCliente" BorderStyle="None" RowStyle-BorderColor="#CED4DA" RowStyle-BorderStyle="Solid" RowStyle-BorderWidth="0.5pt" AutoGenerateColumns="false">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkBtnEdit" runat="server" CommandArgument='<%# Eval("DocumentoCliente")%>'
                                                                CommandName="rowEdit" OnClick="lnkBtnEdit_Click" ToolTip="Ver registro"><img src="../../library/dashboardAdmin/images/Ver.svg" alt="ver registro" style="width: 30px; height: 30px; padding: 2px;" /></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
