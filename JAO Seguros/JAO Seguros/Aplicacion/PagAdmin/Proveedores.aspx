<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="JAO_Seguros.Aplicacion.PagAdmin.Proveedores" %>
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="card">
                            <div class="card-body">
                                <a type="button" class="btn btn-primary btn-icon-text" href="CrearProveedor.aspx" style="float: right;">
                                    <i class="ti-plus btn-icon-prepend"></i>
                                    Proveedor
                                </a>
                                <h4 class="card-title">Proveedores actuales de los seguros</h4>
                                <br>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="TablaProveedoresActivos" CssClass="table" GridLines="None" runat="server" DataKeyNames="NitAseguradora" BorderStyle="None" RowStyle-BorderColor="#CED4DA" RowStyle-BorderStyle="Solid" RowStyle-BorderWidth="0.5pt" AutoGenerateColumns="false">
                                                <Columns>
                                                    <asp:BoundField HeaderText="Nit. Aseguradora" DataField="NitAseguradora" />
                                                    <asp:BoundField HeaderText="Nombre/Razón Social" DataField="NombreAseguradora" />
                                                    <asp:BoundField HeaderText="Dirección Atención" DataField="DireccionAseguradora" />
                                                    <asp:BoundField HeaderText="Teléfono Atención" DataField="TelefonoAseguradora" />
                                                    <asp:BoundField HeaderText="Correo de Atención" DataField="CorreoAseguradora" />
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <asp:Label ID="lblAction" runat="server" Text="Acción"></asp:Label>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkBtnEdit" runat="server" CommandArgument='<%# Eval("NitAseguradora")%>'
