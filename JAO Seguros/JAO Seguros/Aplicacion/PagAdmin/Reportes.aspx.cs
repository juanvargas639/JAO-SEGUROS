...
namespace JAO_Seguros.Aplicacion.PagAdmin
{
    public partial class Reportes : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!IsPostBack)
            {
                ...
                else
                {
                    ...
                    List<Reporte> listaReportes = gestionReporte.listadoReportes();
                    TablaReportesActivos.DataSource = listaReportes;
                    TablaReportesActivos.DataBind();
                    // Requerido para que funcione jQuery DataTables.
                    TablaReportesActivos.UseAccessibleHeader = true;
                    TablaReportesActivos.HeaderRow.TableSection = TableRowSection.TableHeader;
                }
            } else
            {
                /*--RESTRINGIR AL USUARIO SI ACCEDE A LA PÁGINA SIN LOGUEO--*/
        ...
        protected void lnkBtnEdit_Click(object sender, EventArgs e)
        {
            ...
            string id = Convert.ToString(TablaReportesActivos.DataKeys[gvRow.RowIndex].Value);
