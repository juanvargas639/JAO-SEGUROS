<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cotizaciones.aspx.cs" Inherits="JAO_Seguros.Aplicacion.PagAdmin.Cotizaciones" %>
<!DOCTYPE html>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="TablaCotizacionesActivas" CssClass="table" GridLines="None" runat="server" DataKeyNames="IDCotizacion" BorderStyle="None" RowStyle-BorderColor="#CED4DA" RowStyle-BorderStyle="Solid" RowStyle-BorderWidth="0.5pt" AutoGenerateColumns="false">
                                                <Columns>
